...
def create_question(question_asked, days):
    """Create a question with the given question_asked and 
...
class QuestionIndexViewTests(TestCase):
    ...
    def test_past_question(self):
        ...
        index page.
        """
        create_question(question_asked="Past question.",
                        days=-30)
        response = self.client.get(reverse('polls:index'))
    ...
    def test_future_question(self):
        ...
        on the index page
        """
        create_question(question_asked="Future question.",
                        days=30)
        response = self.client.get(reverse('polls:index'))
        self.assertQuerysetEqual(
            response.context['latest_question_list'],
    ...
    def test_future_question_and_past_question(self):
        ...
        """
        create_question(
            question_asked="Past question.",
            days=-30
        )
        create_question(
            question_asked="Future question.",
            days=30
        )
        response = self.client.get(reverse("polls:index"))
        self.assertQuerysetEqual(
    ...
    def test_two_past_question(self):
        ...
        """
        create_question(
            question_asked="Past question 1.",
            days=-30
        )
        create_question(
            question_asked="Past question 2.",
            days=-5
        )
        response = self.client.get(reverse("polls:index"))
        self.assertQuerysetEqual(
